...
repoDir="https://raw.githubusercontent.com/skynetcenter/multi-vpn/main/"
...
updateScript() {
	...
	wget -O /multivpn/cron.daily "${repoDir}files/cron.daily" > /dev/null 2>&1
